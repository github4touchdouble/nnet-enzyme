...
\begin{methods}
\section{Methods}
The protein data was taken from the UniProt database and used in the CLEAN publication on Enzyme function prediction[1]. %% FIX: Cite
The mass table of common amino acids was taken from Bioinformatics Solutions Inc[2]. %% FIX: Cite
...
To simplify the embeddings, we applied Principal Component Analysis (PCA)[3] %% FIX: Cite
...
We also used the method SelectFromModel[4] from the scikit-learn library %% FIX: Cite
