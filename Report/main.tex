...
which assigns a new object to the most common class amongst the most similar k objects in the data set. [1]. We implemented three kNN models in Python using scikit-learns Nearest Neighbors library and 
