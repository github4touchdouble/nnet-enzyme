...
The architecture of the model consists of layers sized at 2560, the input layer, hidden layers being 2048,
...
The dataset we used for evaluation is called ``New-392'' and was used as one of the  benchmark datasets in the CLEAN publication (see \cite{CleanArticle}).
It contains 392 sequences, of which we also removed all sequences containing an ambiguous amino acid, such as 'U' or 'O', from the dataset.
