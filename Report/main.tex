...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\columnwidth]{./assets/l1_dist_enzymes.png}
...
% TODO: Insert Kida Part <27.01.24, Malte Weyrich> %
% Kida
...
% \caption{Level 2 model comparison of FNN, CLEAN and the random baseline}\label{fig:FNN_scores_l2}
% \end{figure}
