...
% TODO: What about the comparison plots <27.01.24, Malte Weyrich> %
...
% TODO: All models need to be introduced here, even the ones we mention in sulpplementary information <27.01.24, Malte Weyrich> %
...
% - mention ewat it is (3 sentences)
...
% TODO: Check reason for length cutoff again <19.01.24, Malte Weyrich> %
...
% Truc
% TODO: find author of mass table / another source
...
\begin{figure}[!htpb]
\includegraphics[width=0.95\textwidth]{./assets/l2_dist_all_train_ver.png}
...
% - What is it -> data set from clean it came from ... redundancy reduction, ... data cutoff, d
...
\begin{figure}[!hb]
\includegraphics[width=0.95\textwidth]{assets/Results_Truc_1.jpeg}
...
% \begin{figure}[!ht]
% \includegraphics[width=\textwidth]{assets/Results_Truc_4.jpeg}
...
\lipsum[1]
\begin{figure}[!htb]
\includegraphics[width=0.95\textwidth]{assets/l2_conf_test_new_all.png}
...
\begin{figure}[!tb]
	\includegraphics[width=0.9\textwidth]{./assets/l0_combined_scores.png}
