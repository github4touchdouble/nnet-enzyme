...
Meanwhile, the ESM-2 embeddings, each represented by a 2 560-dimensional vector, underwent statistical analysis.
We calculated the median, standard deviation, and vector magnitude for each sample in the dataset. % by aggregating values across all 2 560 dimensions for each protein.
...
including a total of $401$ features: mass, embeddings median, embeddings standard deviation (std), embeddings magnitude, and dimension $1$ to $397$ of the reduced 
embeddings. 
...
% TODO: look at comments <29.01.24, Malte Weyrich> %
