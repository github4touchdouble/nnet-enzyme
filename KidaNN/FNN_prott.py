...
def loadData(embPath=r"T:/Projects/Prog/RNN/Dataset/split10_prott5.h5",
             csvPath='T:/Projects/Prog/RNN/Dataset/split10.csv'):
    enzymeSequences = []
    listOfHeaders = []
...
class FNN(nn.Module):
    def __init__(self):
        ...
        self.stack = nn.Sequential(
            ...
            nn.LeakyReLU(),
            nn.Linear(512, 7, dtype=torch.float32),
            nn.Softmax(1),
        )
